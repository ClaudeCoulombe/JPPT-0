...
En entraînant à faible coût JPPT-0 sur de petits corpus spécialisés, par exemples des lettres de motivations, il est relativement facile de créer de petites applications sans péter son budget calcul.   
